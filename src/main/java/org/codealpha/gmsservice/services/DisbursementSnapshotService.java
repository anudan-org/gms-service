...
public class DisbursementSnapshotService {
    ...
    public List<DisbursementSnapshot> getDisbursementSnapshotForDisbursement(Long disbursementId) {
        return disbursementSnapshotRepository.getReportShanpshotsForReport(disbursementId);
    }
}