...
public class ReportHistory {
    ...
    // @OneToMany(mappedBy = "report",fetch = FetchType.EAGER)
        ...
        @JoinColumn(
            name = "report_id",              // column in ReportStringAttribute table
            referencedColumnName = "id"     // column in ReportHistory table (original report id)
        )
    @JsonProperty("stringAttribute")
    @Schema(name = "stringAttributes",description = "Report template structure with values",type = "List<ReportStringAttributes>")
