...
INSERT into public.granters (id, host_url, image_name, navbar_color)
values (3, 'tatr', 'tata_trust.png', '#D35683');
...
VALUES (4, 'anudan', 'anudan.png', '#a41029');
...
VALUES (1, 'IHF - Malaria Quest',
        ...
        now(), 'System', null, null, 2, 'DRAFT', null, '2019-02-01', '2020-01-31');
...
-- Quantitative KPIs
insert into public.grant_quantitative_kpi_data (actuals, goal, status, submit_by_date, submitted_on_date, grant_kpi_id) values (0,100,'NOT_SUBMITTED','2019-04-30',NULL,1);
insert into public.grant_quantitative_kpi_data (actuals, goal, status, submit_by_date, submitted_on_date, grant_kpi_id) values (0,100,'NOT_SUBMITTED','2019-07-31',NULL,1);
insert into public.grant_quantitative_kpi_data (actuals, goal, status, submit_by_date, submitted_on_date, grant_kpi_id) values (0,100,'NOT_SUBMITTED','2019-10-31',NULL,1);
insert into public.grant_quantitative_kpi_data (actuals, goal, status, submit_by_date, submitted_on_date, grant_kpi_id) values (0,100,'NOT_SUBMITTED','2020-01-31',NULL,1);
