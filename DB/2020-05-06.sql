alter table grants add column reference_no text default null;

alter table grant_history add column reference_no text default null;
...
insert into app_config (config_name,config_value,configurable) values('GENERATE_GRANT_REFERENCE','true',true);