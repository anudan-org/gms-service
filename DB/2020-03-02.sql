...
<p style="color: #000;">You have received an automated workflow alert for %TENANT%. Click on <a href="%REPORT_LINK%">%REPORT_NAME%</a> to review.</p>
<p>&nbsp;</p>
...
<p style="text-align: center; color: #000;">Social Alpha | India | <a href="https://www.socialalpha.org">www.socialalpha.org</a></p>' where config_name='REPORT_STATE_CHANGED_MAIL_MESSAGE';
...
update app_config set config_value='Workflow Alert | Status of %REPORT_NAME% has changed.' where config_name='REPORT_STATE_CHANGED_MAIL_SUBJECT';